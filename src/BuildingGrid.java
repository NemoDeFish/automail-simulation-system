...
public class BuildingGrid {
    ...
    /**
     * The constructor, initializes the building grid with given number of floors and rooms
     * @param NUMFLOORS number of rows in a table
     * @param NUMROOMS number of columns in a table
     */
